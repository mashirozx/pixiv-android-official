...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    invoke-virtual {p1}, La/f;->b()Ljava/lang/String;
...
.method final declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILa/f;J)V
...
.method public final connect(Lokhttp3/OkHttpClient;)V
    ...
    invoke-interface {p1}, Lokhttp3/Call;->timeout()La/u;

    move-result-object p1

    invoke-virtual {p1}, La/u;->clearTimeout()La/u;
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:La/d;
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:La/e;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLa/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public final onReadMessage(La/f;)V
    .locals 1
...
.method public final declared-synchronized onReadPing(La/f;)V
    .locals 1
...
.method public final declared-synchronized onReadPong(La/f;)V
    .locals 0
...
.method final declared-synchronized pong(La/f;)Z
    .locals 1
...
.method public final send(La/f;)Z
    .locals 1
...
.method final writeOneFrame()Z
    ...
    .line 494
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(La/f;)V
    ...
    iget-object v1, v1, Lokhttp3/internal/ws/RealWebSocket$Message;->data:La/f;
    ...
    .line 498
    invoke-virtual {v0, v2, v4, v5}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)La/s;
    ...
    .line 500
    invoke-interface {v0, v1}, La/d;->c(La/f;)La/d;
    ...
    iget-object v4, v4, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:La/f;

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILa/f;)V
